...
<body>
	<div class="container col-9 bg-light p-5 rounded">
        <h1 class="display-4">Create a New Student</h1>
        <form:form action="/students/new" method="POST" modelAttribute="s">
            <form:select class="form-select" path="dorm">
                <option selected>Select a Dorm</option>
